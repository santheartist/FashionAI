...
const modelInfo = {
  autoencoder: {
    title: 'Autoencoder',
    description: 'Variational Autoencoder for fashion image generation',
    icon: Zap,
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-secondary-900">{model.title}</h1>
          ...
          >
            <div className="card sticky top-8">
              ...
              <div className="mt-6 pt-6 border-t border-secondary-200">
                <h3 className="text-sm font-medium text-secondary-700 mb-3">Example Prompts:</h3>
              ...
              {lastGeneration && (
                <div className="card">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      <span className="text-secondary-600">Model:</span>
                      <div className="font-medium">{lastGeneration.model_used}</div>
                    </div>
                    <div>
                      <span className="text-secondary-600">Images:</span>
                      <div className="font-medium">{lastGeneration.generated_images.length}</div>
                    </div>
                    <div>
                      <span className="text-secondary-600">Time:</span>
                      <div className="font-medium">{lastGeneration.generation_time.toFixed(2)}s</div>
                    </div>
                    <div>
                      <span className="text-secondary-600">Prompt:</span>
                      <div className="font-medium truncate">{lastGeneration.prompt_used}</div>
                    </div>
                  </div>
                </div>
              )}
              ...
              {loading ? (
                <div className="card">
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium mb-2">Generating Fashion Items</h3>
                ...
                <div className="card">
                  <div className="text-center py-12">
                    <IconComponent className="w-12 h-12 mx-auto mb-4 text-secondary-400" />
